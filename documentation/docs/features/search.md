...
2. Query using natural language to find relevant entries from your knowledge base. Use [query filters](../miscellaneous/advanced.md#query-filters) to limit entries to search
