...
1. Select files and folders to index [using the desktop client](./get-started/setup?id=_2-download-the-desktop-client). When you click 'Save', the files will be sent to your server for indexing.
