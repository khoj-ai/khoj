...
1. Create a new [Chat API Provider](http://localhost:42110/server/admin/database/chatapiprovider/add) in the server admin settings.
...
![example configuration for chat api provider](/img/example_openai_processor_config.png)
...
2. Create a new [chat model options](http://localhost:42110/server/admin/database/chatmodeloptions/add)
    ...
    - Set the `chat api provider` field to the Anthropic Chat API Provider you created in step 1.
  </TabItem>
...
2. Create a new [chat model options](http://localhost:42110/server/admin/database/chatmodeloptions/add)
    ...
    - Set the `chat api provider` field to the Gemini Chat API Provider you created in step 1.
