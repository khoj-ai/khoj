...
from alphamind.database.adapters import AgentAdapters, ConversationAdapters
from alphamind.database.models import Agent, ChatMessageModel, ChatModel, AlphaMindUser, UserMemory
from alphamind.processor.conversation.utils import (
    AgentMessage,
    OperatorRun,
    construct_chat_history_for_operator,
)
from alphamind.processor.operator.operator_actions import RequestUserAction
from alphamind.processor.operator.operator_agent_anthropic import AnthropicOperatorAgent
from alphamind.processor.operator.operator_agent_base import OperatorAgent
from alphamind.processor.operator.operator_agent_binary import BinaryOperatorAgent
from alphamind.processor.operator.operator_agent_openai import OpenAIOperatorAgent
from alphamind.processor.operator.operator_environment_base import (
    Environment,
    EnvironmentType,
    EnvStepResult,
)
from alphamind.processor.operator.operator_environment_browser import BrowserEnvironment
from alphamind.processor.operator.operator_environment_computer import ComputerEnvironment
from alphamind.routers.helpers import ChatEvent, get_message_from_queue
from alphamind.utils.helpers import timer
from alphamind.utils.rawconfig import LocationData
...
async def operate_environment(
    ...
    max_iterations = int(os.getenv("ALPHAMIND_OPERATOR_ITERATIONS", 100))
