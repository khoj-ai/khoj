...
from alphamind.database.models import GithubConfig, AlphaMindUser
...
from alphamind.utils.helpers import is_none_or_empty, timer
from alphamind.utils.rawconfig import GithubContentConfig, GithubRepoConfig
...
class GithubToEntries(TextToEntries):
    ...
    def process(self, files: dict[str, str], user: AlphaMindUser, regenerate: bool = False) -> Tuple[int, int]:
    ...
    def update_entries_with_ids(self, current_entries, user: AlphaMindUser = None):
