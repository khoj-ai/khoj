...
from alphamind.processor.conversation.openai.utils import (
...
from alphamind.utils.helpers import ToolDefinition
...
def openai_send_message_to_model(
    ...
    elif response_schema and json_support >= StructuredOutputSupport.SCHEMA and not is_groq_api(api_base_url):
