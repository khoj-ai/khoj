...
SEARXNG_URL = os.getenv("ALPHAMIND_SEARXNG_URL")
# Exa API credentials
EXA_API_KEY = os.getenv("EXA_API_KEY")

# Whether to automatically read web pages from search results
AUTO_READ_WEBPAGE = is_env_var_true("ALPHAMIND_AUTO_READ_WEBPAGE")
...
async def search_with_exa(query: str, location: LocationData) -> Tuple[str, Dict[str, List[Dict]]]:
    ...
    headers = {"Content-Type": "application/json", "x-api-key": EXA_API_KEY, "x-exa-integration": "alphamind"}
...
async def read_webpage_with_exa(web_url: str, api_key: str, api_url: str) -> str:
    ...
    headers = {"Content-Type": "application/json", "x-api-key": api_key, "x-exa-integration": "alphamind"}
    params = {
        "urls": [web_url],
        "text": True,
