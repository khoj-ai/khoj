...
from alphamind.utils.helpers import ImageIntentType


class AlphaMindDjangoJobAdmin(DjangoJobAdmin, unfold_admin.ModelAdmin):
    list_display = (
        "id",
        "next_run_time",
        "job_info",
...
class AlphaMindDjangoJobExecutionAdmin(DjangoJobExecutionAdmin, unfold_admin.ModelAdmin):
    pass


admin.site.unregister(DjangoJob)
admin.site.register(DjangoJob, AlphaMindDjangoJobAdmin)
admin.site.unregister(DjangoJobExecution)
admin.site.register(DjangoJobExecution, AlphaMindDjangoJobExecutionAdmin)
...
class AlphaMindUserAdmin(UserAdmin, unfold_admin.ModelAdmin):
...
admin.site.register(AlphaMindUser, AlphaMindUserAdmin)
...
class AlphaMindUserSubscription(unfold_admin.ModelAdmin):
    list_display = (
        "id",
        "user",
        "type",
    ...
    def export_selected_objects(self, request, queryset):
        ...
        for conversation in queryset:
            ...
            for idx, log in enumerate(chat_log):
                if log["by"] == "alphamind" and log["images"]:
