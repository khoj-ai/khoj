...
from alphamind.database.models import GithubConfig, GithubRepoConfig, NotionConfig
...
from alphamind.utils.rawconfig import GithubContentConfig, NotionContentConfig
