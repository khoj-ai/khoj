...
from alphamind.configure import initialize_content
from alphamind.database import adapters
from alphamind.database.adapters import ConversationAdapters, EntryAdapters, get_user_photo
from alphamind.database.models import AlphaMindUser, SpeechToTextModelOptions, UserConversationConfig
from alphamind.processor.conversation.openai.whisper import transcribe_audio
...
from alphamind.utils.rawconfig import SearchResponse
...
def update(
    ...
    return {"status": "ok", "message": "alphamind reloaded"}
