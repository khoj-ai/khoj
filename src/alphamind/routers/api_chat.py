...
from alphamind.app.settings import ALLOWED_HOSTS
...
from alphamind.database.models import Agent, AlphaMindUser
from alphamind.processor.conversation import prompts
from alphamind.processor.conversation.openai.utils import is_local_api
from alphamind.processor.conversation.prompts import no_entries_found
...
from alphamind.processor.image.generate import text_to_image
from alphamind.processor.operator import operate_environment
from alphamind.processor.speech.text_to_speech import TextToSpeechError, generate_text_to_speech
from alphamind.processor.tools.online_search import (
    deduplicate_organic_results,
    read_webpages,
    search_online,
)
from alphamind.processor.tools.run_code import run_code
from alphamind.routers.email import send_query_feedback
...
from alphamind.routers.research import ResearchIteration, research
from alphamind.routers.storage import upload_user_image_to_bucket
...
def duplicate_chat_history_public_conversation(
    ...
    if scheme == "http" and not is_env_var_true("ALPHAMIND_NO_HTTPS") and not is_local_api(f"{request.base_url}"):
        scheme = "https"
...
async def event_generator(
    ...
    chat_metadata: dict = {}
    conversation = None
    user: AlphaMindUser = user_scope.object
