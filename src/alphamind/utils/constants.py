...
web_directory = app_root_directory / "alphamind/interface/web/"
home_directory = web_directory / "home/"
next_js_directory = app_root_directory / "alphamind/interface/built/"
pypi_static_directory = app_root_directory / "alphamind/interface/compiled/"
assetlinks_file_path = web_directory / ".well-known/assetlinks.json"
empty_escape_sequences = "\n|\r|\t| "
app_env_filepath = "~/.alphamind/env"
telemetry_server = "https://alphamind.beta.haletic.com/v1/telemetry"
content_directory = "~/.alphamind/content/"
...
empty_config = {
    "search-type": {
        "image": {"encoder": "sentence-transformers/clip-ViT-B-32", "model_directory": "~/.alphamind/search/image/"},
    },
}
