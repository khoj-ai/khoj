...
def generate_image_with_openai(
    ...
    if text_to_image_config.api_key:
        ...
        openai_client = openai.OpenAI(api_key=api_key, timeout=60.0, max_retries=3)
        ...
        openai_client = openai.OpenAI(api_key=api_key, base_url=api_base_url, timeout=60.0, max_retries=3)
