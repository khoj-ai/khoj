...
e2b_sandbox_context = """
- The sandbox has access to only the standard library, matplotlib, pandas, numpy, scipy, bs4, sympy, einops, biopython, shapely and rdkit packages. The requests, torch, catboost, tensorflow and tkinter packages are not available.
""".strip()
