  ...
  return `
        ...
        ${
          userInfo && userInfo.is_active
            ...
            ${
              has_documents
                ? '<a id="search-nav" class="khoj-nav" href="./search.html"><img class="nav-icon" src="./assets/icons/search.svg" alt="Search"> <span class="khoj-nav-item-text">Search</span></a>'
                : ""
            }
            ${
              username
                ...
                <div id="khoj-nav-menu-container" class="khoj-nav dropdown">
                    ${
                      user_photo && user_photo != "None"
                        ? `
                        <img id="profile-picture" class="${
                          is_active ? "circle subscribed" : "circle"
                        }" src="${user_photo}" alt="${username[0].toUpperCase()}" referrerpolicy="no-referrer">
                    `
                        : `
                        <div id="profile-picture" class="${
                          is_active
                            ? "circle user-initial subscribed"
                            : "circle user-initial"
                        }" alt="${username[0].toUpperCase()}">${username[0].toUpperCase()}</div>
                    `
                    }
