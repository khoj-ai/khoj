...
export default function SettingsView() {
    ...
    useEffect(() => {
        ...
        if (typeof window !== "undefined") {
            ...
            setGithubConnected(params.get("github_connected") === "true");
        }
    }, [initialUserConfig]);
                                ...
                                >
                                    ...
                                    <div className="section grid gap-8">
                                        ...
                                        <div className="cards flex flex-wrap gap-16">
                                            ...
                                            <Card id="github" className={`${cardClassName}`}>
                                                ...
                                                <CardFooter className="flex flex-wrap gap-4">
                                                    ...
                                                    userConfig.enabled_content_source.github ? (
                                                        <GitHubRepoSelector
                                                            openExternally={githubConnected}
                                                        />
                                                    ) : (
                                                        <Button
                                                            variant="outline"
                                                    ...
                                                    <Button
                                                        variant="outline"
                                                        size="sm"
                                                        className={`${githubConnected || userConfig.enabled_content_source.github || "hidden"}`}
                                                        onClick={() => disconnectContent("github")}
                                                    >
                                                        <CloudSlash className="h-5 w-5 inline mr-1" />
                                                        Disable
                                                    </Button>
