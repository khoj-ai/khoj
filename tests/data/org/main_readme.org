...
** Use
*** *AlphaMind via Emacs*  [[https://alphamind.dev][link to alphamind website]]  :@EMACS:CLIENT_1:ALPHAMIND:
     - [[https://github.com/alphamind-ai/alphamind/tree/master/interface/emacs#installation][Install]] [[./interface/emacs/alphamind.el][alphamind.el]]
     - Run ~M-x alphamind <user-query>~ or Call ~C-c C-s~
...
*** *AlphaMind via API*
     ...
     - [[http://localhost:42110/docs][AlphaMind API Docs]]

*** *Call AlphaMind via Python Script Directly*
     #+begin_src shell
