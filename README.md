...
- Get answers from the internet and your docs (including images, PDF, markdown, org-mode, word, notion files).
...
- Run it privately on [your computer](https://docs.khoj.dev/get-started/setup).
